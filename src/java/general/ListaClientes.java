...
public class ListaClientes extends BeanBase {
    private List items=null;

    public ListaClientes() throws Exception{
        getLista();
    }
    ...
    public void getLista() throws Exception {
        ...
        try{
            ...
            Query q=session.createQuery("from Cliente a order by a.nombre");
            Iterator i=q.list().iterator();
            
            while (i.hasNext()){
                   Cliente p=(Cliente) i.next(); 
                   item=new SelectItem();
