 ...
 * @author rafael
 */
@ManagedBean(name="listapaises")
@SessionScoped

public class ListaPaises extends BeanBase {
    private List items=null;

    public ListaPaises() throws Exception{
        getLista();
    }
    ...
    public void getLista() throws Exception {
        ...
        try{
            ...
            Query q=session.createQuery("from Pais a order by a.nombre");
