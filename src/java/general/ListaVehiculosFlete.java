 ...
 * @author rafael
 */
@ManagedBean(name="listavehiculosflete")
@SessionScoped

public class ListaVehiculosFlete extends BeanBase {
    private List items=null;

    public ListaVehiculosFlete() throws Exception{
        getLista();
    }
    ...
    public void getLista() throws Exception {
        ...
        try{
            ...
            Query q=session.createQuery("from VehiculoFlete a order by a.nombre");
            Iterator i=q.list().iterator();
            
            while (i.hasNext()){
                   VehiculoFlete p=(VehiculoFlete) i.next(); 
                   item=new SelectItem();
